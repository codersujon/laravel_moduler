                ...
                <ul class="side-nav">
                    ...
                    @foreach ($sidebars as $item)
                        <li class="side-nav-item">
                            <a data-bs-toggle="collapse" href="#sidebarHospital{{ $loop->iteration }}" aria-expanded="false" aria-controls="sidebarHospital" class="side-nav-link">
                    ...
                    <div class="topbar-item d-none d-md-flex">
                        <div class="dropdown">
                            @foreach($menus as $menu)
                                <a href="{{ $menu->route ? route($menu->route) : $menu->url}}" class="topbar-link btn btn-link px-2 dropdown-toggle drop-arrow-none fw-medium" aria-haspopup="false" aria-expanded="false">
                                    {{ $menu->title }}
                                </a>
                            @endforeach
                        </div> <!-- .dropdown-->
