...
<head>
    <meta charset="utf-8" />
    <title>@yield('title', 'Cargoaim Dashboard')</title>
    ...
    <!-- gridjs css -->
    <link rel="stylesheet" href="{{ asset('backend')}}/assets/vendor/gridjs/theme/mermaid.min.css">
...
<body>
    ...
    <div class="wrapper">
         ...
         <!-- Sidenav Menu Start -->
        @include('menu::components.layouts.sidebar')
         <!-- Sidenav Menu End -->
        
        <!-- Topbar Start -->
       @include('menu::components.layouts.topbar')
        <!-- Topbar End -->
        ...
        <div class="page-content">
            ...
            <!-- Footer Start -->
                @include('menu::components.partials.footer')
            <!-- end Footer -->
    ...
    <!-- gridjs js -->
    <script src="{{ asset('backend')}}/assets/vendor/gridjs/gridjs.umd.js"></script>

    <script src="{{ asset('backend')}}/assets/js/pages/table-gridjs.js"></script>
